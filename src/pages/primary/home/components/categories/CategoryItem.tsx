...
export const CategoryItem = (props: CategoryItemProps) => {
  ...
  return (
    <button
      ...
      ${isSelected ? `scale-110 bg-primary font-medium text-color-dark shadow-md dark:bg-primary dark:text-color-dark` : `bg-secondary text-light shadow-sm hover:scale-110 hover:bg-hover hover:shadow-md dark:bg-secondary-dark dark:text-light-dark dark:hover:bg-hover-dark`} 
      ${className}
      `}
      {...rest}
    >
